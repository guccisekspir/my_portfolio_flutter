    ...
    return VisibilityDetector(
      ...
      child: SizedBox(
        ...
        child: Column(
          children: [
            const Spacer(),
            sizeHelper.isSmallScreen
                ? Column(
                    children: [
                      ConstrainedBox(
                        constraints: BoxConstraints(
                          maxHeight: sizeHelper.height! * 0.3,
                          maxWidth: sizeHelper.width! * 0.8,
                        ),
                        child: Image.asset("assets/logos/sekspir.png"),
                      ),
                      ConstrainedBox(
                        constraints: BoxConstraints(
                          maxHeight: sizeHelper.height! * 0.6,
                          maxWidth: sizeHelper.width! * 0.8,
                        ),
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: AutoSizeText(
                                ...
                                minFontSize: 6,
                                style:
                                    GoogleFonts.poppins(fontWeight: FontWeight.w200, color: themeHelper.onBackground),
                              ),
                            ),
                          ],
                        ),
